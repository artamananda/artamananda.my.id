...
func routeIndexGet(w http.ResponseWriter, r *http.Request) {
    if r.Method == "GET" {
        ...
        var workingDirectory = "/home/user/go/src/artamananda.my.id"
        var file = filepath.Join(workingDirectory, "views", "message.html")
		var header = filepath.Join(workingDirectory, "views", "header.html")
		var footer = filepath.Join(workingDirectory, "views", "footer.html")
